...
def query_cellbase(gc, HGNC_df, HGNC_missing_ensemblID, ensemblID_not_in_cellbase, ensemblID_has_no_maneselect_refseq, all_genes):
    ...
    Inputs:
        ...
        HGNC_missing_ensemblID: empty list for HGNC ID that dont have an ensembl gene
        ensemblID_not_in_cellbase: empty list for ensembl gene id not in cellbase
        ensemblID_has_no_maneselect_refseq: empty list for ensembl genes that dont have maneselect_refseq
    ...
    Returns:
        ...
        HGNC_missing_ensemblID: list for HGNC ID that dont have an ensembl gene
        ensemblID_not_in_cellbase: list for ensembl gene id not in cellbase
        ensemblID_has_no_maneselect_refseq: list for ensembl genes that dont have maneselect_refseq
    """
